...
const categories = [
  {
    ...
    icon: '🔥',
    products: ['Antiscalants', 'pH Boosters', 'Oxygen Scavengers', 'Online Descaling Chemicals', 'Furnace Oil Additives'],
  ...
  },
  {
    ...
    label: 'RO Chemicals',
    icon: '💧',
    products: ['RO Antiscalants', 'pH Boosters', 'Membrane Cleaning Chemicals', 'Algae Control Chemicals'],
  ...
  },
  {
    ...
    icon: '🌡️',
    products: ['Custom formulations based on metal composition', 'Water quality-specific treatment blends', 'Biocide programs', 'Scale inhibition packages'],
            ...
            <div className="grid-2" style={{ gap: '28px' }}>
              ...
              <div className="chem-panel-info">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  <a href="https://wa.me/918247292504?text=Hello%2C%20I%20need%20chemical%20solutions%20for%20my%20facility." className="btn btn-whatsapp" id={`chemWa-${active}`} style={{ justifyContent: 'center' }}>
        ...
        <div className="container">
          <div className="reveal">
            ...
            <div className="cta-btns">
              <a href="tel:+918247292504" className="btn btn-copper" id="chemCtaCall">
