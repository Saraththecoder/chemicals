...
const services = [
  ...
  { icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="7" width="20" height="10" rx="2"/><line x1="7" y1="7" x2="7" y2="17"/><line x1="12" y1="7" x2="12" y2="17"/><line x1="17" y1="7" x2="17" y2="17"/></svg>, title: 'Heat Exchanger Descaling', img: '/services/heat.png', desc: 'Professional chemical descaling to remove scale deposits and improve heat transfer efficiency.' },
            ...
            <div className="reveal reveal-delay-2">
              <div className="grid-2" style={{ gap: '16px' }}>
                {[
                  ...
                  { bg: 'var(--copper-50)', border: '1px solid var(--copper-100)', color: 'var(--grey-900)', numColor: 'var(--copper-500)', count: 8, suffix: '+', label: 'Core Services' },
